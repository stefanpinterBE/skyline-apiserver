...
list_rules = (
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/healthmonitors")],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="POST", path="/v2.0/lbaas/healthmonitors")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/healthmonitors/{healthmonitor_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/healthmonitors/{healthmonitor_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/lbaas/healthmonitors/{healthmonitor_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/l7policies")],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="POST", path="/v2.0/lbaas/l7policies")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/l7policies/{l7policy_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/l7policies/{l7policy_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/lbaas/l7policies/{l7policy_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/l7policies/{l7policy_id}/rules")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="POST", path="/v2.0/lbaas/l7policies/{l7policy_id}/rules")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/l7policies/{l7policy_id}/rules/{l7rule_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/l7policies/{l7policy_id}/rules/{l7rule_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/lbaas/l7policies/{l7policy_id}/rules/{l7rule_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/listeners")],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="POST", path="/v2.0/lbaas/listeners")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/listeners/{listener_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/listeners/{listener_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/lbaas/listeners/{listener_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/listeners/{listener_id}/stats")],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/pools/{pool_id}/members")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="POST", path="/v2.0/lbaas/pools/{pool_id}/members")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/pools/{pool_id}/members/{member_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/pools/{pool_id}/members/{member_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/lbaas/pools/{pool_id}/members/{member_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/pools")],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="POST", path="/v2.0/lbaas/pools")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/pools/{pool_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/pools/{pool_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/lbaas/pools/{pool_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/providers")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/quotas")],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/quotas/{project_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/quotas/{project_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/lbaas/quotas/{project_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/quotas/{project_id}/default")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/octavia/amphorae")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/octavia/amphorae/{amphora_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/octavia/amphorae/{amphora_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/octavia/amphorae/{amphora_id}/config")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/octavia/amphorae/{amphora_id}/failover")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/octavia/amphorae/{amphora_id}/stats")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/providers/{provider}/flavor_capabilities")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/providers/{provider}/availability_zone_capabilities")],
    ),
)
